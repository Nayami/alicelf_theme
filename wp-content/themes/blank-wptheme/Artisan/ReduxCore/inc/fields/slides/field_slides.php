		...
		public function render()
		{
			...
			if ( isset ( $this->value ) && is_array( $this->value ) && ! empty ( $this->value ) ) {
				...
				foreach ( $slides as $slide ) {
					...
					if ( $this->field[ 'show' ][ 'quick_notes' ] ) {
						$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'quick_notes' ] ) ) ? esc_attr( $this->field[ 'placeholder' ][ 'quick_notes' ] ) : __( 'Quick Notes', 'redux-framework' );
						echo '<li><textarea name="' . $this->field[ 'name' ] . '[' . $x . '][quick_notes]' . $this->field[ 'name_suffix' ] . '" id="' . $this->field[ 'id' ] . '-quick_notes_' . $x . '" placeholder="' . $placeholder . '" class="large-text">' . esc_attr( $slide[ 'quick_notes' ] ) . '</textarea></li>';
					}
			...
			if ( $x == 0 ) {
				...
				if ( $this->field[ 'show' ][ 'quick_notes' ] ) {
					$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'quick_notes' ] ) ) ? esc_attr( $this->field[ 'placeholder' ][ 'quick_notes' ] ) : __( 'Quick Notes', 'redux-framework' );
					echo '<li><textarea name="' . $this->field[ 'name' ] . '[' . $x . '][quick_notes]' . $this->field[ 'name_suffix' ] . '" id="' . $this->field[ 'id' ] . '-quick_notes_' . $x . '" placeholder="' . $placeholder . '" class="large-text"></textarea></li>';
				}
